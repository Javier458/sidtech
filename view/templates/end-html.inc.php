...
<section class="container-fluid">
    <div class="row px-5 mb-5 footer-info">
        ...
        <div class="col-12 col-md-4 mt-5">
            ...
            <p><a class="links-footer" href="#about-us"><i class="bi bi-people-fill"></i> Contacte con Nosotros</a></p>
            <p><a class="links-footer" href="#faq"><i class="bi bi-question-circle-fill"></i> M&aacute;s Preguntas </a></p>
            <p><a class="links-footer" href="#services"><i class="bi bi-info-circle"></i> Pol&iacute;tica y Privacidad</a></p>
        </div>
        <div class="col-12 col-md-4 mt-5">
